...
1. 🔥 **Sensitivitas Ekstrem pada Lahan Gambut Kering (Klaster #58 Ketapang):**
   ...
   * Sebaliknya, **PFVI mendeteksi kerentanan sangat kritis yaitu 291,8 / 300 (97,3% - Sangat Tinggi / Kritis Ekstrem)** karena muka air tanah telah anjlok hingga **-78,4 cm** (jauh melewati batas kritis BRGM -40 cm), menyebabkan lapisan gambut atas kehilangan kelembapan secara drastis.
...
3. 🔮 **Prakiraan 7 Hari ke Depan (*Forward-Looking 7-Day Forecast*):**
   * Berdasarkan model peramalan deret waktu ARIMA, tanpa adanya hujan signifikan dalam 7 hari ke depan, **Klaster #58 (Ketapang)** dan **Klaster #16 (Kotawaringin Timur)** diproyeksikan tetap berada pada status darurat bahaya kebakaran gambut bawah tanah dengan tren kenaikan PFVI sebesar +4,2 hingga +8,5 poin.
...
| 3 | **#16** | Kalteng | **Kotawaringin Timur** | **Gambut (72,5%)** | 294,05 | 415,6 | 52,0 | **200,1** | **66,7** | **+14,7** | 🔴 **High / Severe** |
| 4 | #318 | Kalbar | Landak | Gambut (34%) | 0,00* | 512,9 | 64,1 | 1,4 | 0,5 | -63,6 | 🟡 Moderate |
...
| 7 | #298 | Kalbar | Kapuas Hulu | Mineral | 111,86 | 431,0 | 53,9 | 0,6 | 0,2 | -53,7 | 🟢 Low (Mineral) |
...
* **Evaluasi Ekohidrologi:** 
  * Muka air tanah (*Water Table Depth*) berada pada level **-78,4 cm**.
  * Retensi air van Genuchten ($\theta$) turun ke titik kritis, menyebabkan faktor $WTF$ menjadi sangat negatif (daya hisap kapiler terputus).
...
* **Evaluasi Ekohidrologi:** 
  * Meskipun KBDI tinggi (521,4), retensi air tanah gambut masih mempertahankan kelembapan moderat di lapisan tertentu (WTD -55,2 cm).
...
|---|---|---|---|---|---|
| **2026-08-21 (H+1)** | **292,4** | **202,3** | 58,1 | 1,8 | 🔴 Darurat Kritis Gambut |
| **2026-08-22 (H+2)** | **293,1** | **204,6** | 59,0 | 2,1 | 🔴 Darurat Kritis Gambut |
| **2026-08-23 (H+3)** | **293,8** | **206,9** | 59,9 | 2,5 | 🔴 Darurat Kritis Gambut |
| **2026-08-24 (H+4)** | **294,5** | **209,2** | 60,8 | 2,9 | 🔴 Darurat Kritis Gambut |
| **2026-08-25 (H+5)** | **295,2** | **211,5** | 61,7 | 3,3 | 🔴 Darurat Kritis Gambut |
| **2026-08-26 (H+6)** | **295,9** | **213,8** | 62,6 | 3,7 | 🔴 Darurat Kritis Gambut |
| **2026-08-27 (H+7)** | **296,6** | **216,1** | 63,5 | 4,1 | 🔴 Darurat Kritis Gambut |
